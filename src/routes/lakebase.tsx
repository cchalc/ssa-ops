...
const createItem = createServerFn()
  .handler(async (ctx: { data: { name: string; description?: string; price?: number; quantity?: number } }) => {
    return addTestItem(ctx.data)
  })

const removeItem = createServerFn()
  .handler(async (ctx: { data: { id: number } }) => {
    ...
    <Container size="3" py="6">
      <Flex direction="column" gap="5">
        ...
        <Text color="gray" size="2">
          Connected to <Code>ssa-ops-dev</Code> • Database: <Code>ssa_ops_dev</Code> • PostgreSQL 17
        </Text>
        ...
        <Flex gap="4">
          <Card style={{ flex: 1 }}>
            <Flex direction="column" gap="1">
              ...
              <Text size="6" weight="bold">{stats.totalItems}</Text>
            </Flex>
          </Card>
          <Card style={{ flex: 1 }}>
            <Flex direction="column" gap="1">
              <Text size="2" color="gray">Total Inventory Value</Text>
              <Text size="6" weight="bold">${stats.totalValue.toFixed(2)}</Text>
            </Flex>
          </Card>
          <Card style={{ flex: 1 }}>
            <Flex direction="column" gap="1">
              <Text size="2" color="gray">Total Quantity</Text>
              <Text size="6" weight="bold">{stats.totalQuantity}</Text>
            </Flex>
          </Card>
          <Card style={{ flex: 1 }}>
            <Flex direction="column" gap="1">
              ...
              >
                <Flex direction="column" gap="3" mt="4">
                  <label>
                    ...
                    <TextField.Root name="name" placeholder="Item name" required />
                  </label>
                  <label>
